...
export const TechSection = () => {
    ...
    return (
        ...
        bg-gradient-to-br from-sky-950 via-slate-900 to-gray-900 overflow-clip">
            <div className="heading-container m-6 h-12 border-b-2 border-b-white/5 flex justify-between">
                <div className="flex self-baseline">
                    <div className="text-[12px] md:text-sm font-bold rounded-t-lg bg-slate-900 py-2 px-3 mb-2">
                        technologies.ts
                    </div>
                    <div className="text-[12px] md:text-sm font-bold py-2 px-3 mb-2">
                        constants.ts
                    </div>
                </div>
            ...
            <div className="body-container flex">
                <div className="hidden md:block markdown ml-6 pr-4 h-full font-extrabold font-mono text-[11px] text-zinc-400 border-r-1 border-r-white/5">
                ...
                <div className="tech-stack-container ml-6 w-full">
                    ...
                    <div
                        className="grid grid-cols-2 md:grid-cols-4 my-4"

                    >
                        {(Object.keys(techStack) as Array<keyof typeof techStack>).map((tech, index) => (

                            <motion.div key={index} className="flex py-2"
                                initial="offscreen"
                            ...
                            >
                                ...
                                <div className="py-3 md:text-lg text-sm">{techStack[tech]}</div>
                            </motion.div>
                        ))}
                    </div>
                    <p className="text-sm text-indigo-500 font-bold pt-3 pbpNav-6">
                        {']'};
                    </p>
                </div>
            </div>
