...
export const UserProfile = () => {
    return (
        <div className="user-profile min-w-[250px] border my-4 border-white/10 rounded-xl p-6 bg-gradient-to-br from-slate-800 to-slate-900 text-sm font-bold self-start">
            <div className="heading flex font-mono font-bold border-b-1 border-b-white/10 pb-2">
                ...
                <span className="text-sm">user@portfoilo:~$</span>
            </div>
