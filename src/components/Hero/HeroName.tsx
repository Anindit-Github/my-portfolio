  ...
  return (
    <div>
      ...
      <div>
        ...
        <span
          className="mx-4 font-mono text-5xl font-extrabold bg-gradient-to-r 
        ...
        <p
          className="mx-6 font-mono text-5xl font-extrabold bg-gradient-to-r 
            from-teal-200 via-teal-300 via-cyan-400 via-blue-400 
            via-blue-500 via-violet-400 via-violet-300 to-purple-700 bg-clip-text text-transparent self-center"
        >
          Panigrahi
        </p>
      </div>
      <div className="my-6 font-mono font-semibold w-full text-lg md:text-xl">
